...
def verifyDistribution(element_data):
    ...
    if (type == 'normalDistribution'):
        ...
        return EXPONENTIALDISTRIBUTION(
            MEAN(str(element_data['arg1'])) #Aquí va arg1 en lugar de Mean
        )
    elif (type == 'uniformDistribution'):
        return UNIFORMDISTRIBUTION(
    ...
    doc_simu = DEFINITIONS(
        SIMULATIONCONFIGURATION(
            ...
            *[EXCLUSIVEGATEWAY(
            ...
            id=rootid, processRef=bpmnId, processInstances="7", startDateTime="2017-08-14T08:00:00.000Z",
            resourceAssignmentOrder="priority,simulationTime"
        ),
...
def print_parameters( output_file, parameters):
    # time_table = [
